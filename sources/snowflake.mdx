...
5. Input the following details:
    ...
    a. **Database Name**: The name of the Snowflake database to sync from
    a. **Warehouse Name**: The name of the warehouse used to run syncs in Snowflake
    a. **Role**: The role name used to run syncs
    a. **Host**: Your [Snowflake url](https://docs.snowflake.com/en/user-guide/admin-account-identifier) (e.g., `abc123.us-east1.gcp.snowflakecomputing.com`) 
