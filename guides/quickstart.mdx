...
and select the [namespace](https://docs.fabra.io/concepts/namespaces) and [table](https://docs.fabra.io/concepts/tables) where Fabra should
load data into for this object.

Fabra will pull the existing columns from your selected table, and you can then use those to define the fields you expect from your
customers. If you want to omit a column, simply check the `omit` checkbox and Fabra will not prompt your customers for that
field. Make sure to provide helpful display names and descriptions, since these will be what your customers see.
<Frame>
