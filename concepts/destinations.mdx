...
[API docs](/api-reference/create-destination) to learn more.
</Note>
...
You can also receive data from Fabra via a webhook. Learn how to set this up [here](/concepts/webhooks).